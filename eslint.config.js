...
const CROSS_MODULE_IMPORT = {
  ...
  regex: '(^|/)peerd-(?!runtime/(?:controller(?:-turn)?|semantic)\\.js$|runtime/contacts/(?:store|aggregate)\\.js$|runtime/observability/contributor-store\\.js$|engine/(?:app-assets|artifact|app-manifest)\\.js$|egress/kernel-storage\\.js$)[a-z]+/(?!index\\.js$|background\\.js$|offscreen\\.js$|repository\\.js$|kernel\\.js$|ui\\.js$).+',
