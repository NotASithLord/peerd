...
/**
 * The content-addressed manifest shape. `sig` is optional (unsigned in
 * the shared/store path; the dweb layer adds it). Other distribution
 * fields are additive, so the type stays open.
 * @typedef {{ sig?: unknown, [k: string]: unknown }} Manifest
 */
