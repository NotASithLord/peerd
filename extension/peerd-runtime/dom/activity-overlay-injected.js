  ...
  try {
    ...
    if (!host) {
      ...
      style.textContent = [
        ...
        '  color: #F3F3EF; background: #1A1C1E;',
        '  border: 1px solid #32353A; border-radius: 10px;',
        ...
        '.origin { color: #ABABA6; font-size: 11px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }',
        '.stop {',
        '  all: initial; cursor: pointer; flex: none;',
        '  font-family: inherit; font-size: 11px; color: #F3F3EF;',
        '  background: #151617;',
        '  border: 1px solid #32353A; border-radius: 6px;',
        '  padding: 4px 8px; margin-left: 2px;',
        '}',
        '.stop:hover { background: #25272A; }',
      ].join('\n');
