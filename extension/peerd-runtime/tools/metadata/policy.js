...
const TOOL_POLICY_ROWS = Object.freeze([
  ...
  ["read_pdf","tab","read",{"kind":"url-or-active","field":"url","mode":"display"}],
  ["read_doc","web","read",{"kind":"url-field","field":"url","mode":"display"}],
  ...
  ["request_review","spawned","read",{"kind":"none"}],
