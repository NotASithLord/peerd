...
export const openTabTool = {
  ...
  description: [
    ...
    "Returns the new tab id. To have the web actor work this tab, message_resident",
    "with to:'<that tabId>' — do NOT combine open_tab with to:'web', which opens its",
    "OWN tab. For a fresh web task, skip open_tab and just message_resident to:'web'",
