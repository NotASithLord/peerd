...
export const APP_RUNTIME_NOTE = [
  ...
  'Prefer native HTML/CSS/JS. Mithril remains available as ./mithril.js when keyed',
  'lists, reusable components, or app-wide redraws justify it. Live web/API work',
