// @ts-check
// Store actor bootstrap. Contributor Metrics is absent from this target. There
// are deliberately no static imports so ambient capabilities are removed before
// the shared semantic runtime evaluates.
export {};
...
void (async () => {
  ...
  const { startActorWorker } = await import('/offscreen/actor-worker-runtime.js');
