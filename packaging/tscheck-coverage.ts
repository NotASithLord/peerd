...
/** Scan the extension + the web demo shell for // @ts-check coverage. Pure
 *  read; no side effects. why web/public too: it is in tsconfig's include and
 *  rides the same opt-in ratchet — the scan must match the checked set or the
 *  floor can never grow to protect web files. */
