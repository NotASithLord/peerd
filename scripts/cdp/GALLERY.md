...
**33 states · 66 screens · baselines `linux-x64`**
...
### 14 · App history and Git (narrow)

`home-library-git-narrow` · `narrow full tab · 310` - The Library panel at the installed sidebar width.

| light | dark |
| --- | --- |
| <img src="baselines/linux-x64/home-library-git-narrow.light.png" alt="App history and Git (narrow) (light)" width="310"> | <img src="baselines/linux-x64/home-library-git-narrow.dark.png" alt="App history and Git (narrow) (dark)" width="310"> |

### 15 · Settings (full tab)
...
### 23 · options-contributor-metrics
...
### 29 · Pod startup failure

`pod-tab-failed` · `full tab · 1280` - The Pod tab explains a missing or invalid sandbox.

| light | dark |
| --- | --- |
| <img src="baselines/linux-x64/pod-tab-failed.light.png" alt="Pod startup failure (light)" width="460"> | <img src="baselines/linux-x64/pod-tab-failed.dark.png" alt="Pod startup failure (dark)" width="460"> |

### 30 · sidepanel-confirm
